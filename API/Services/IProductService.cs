...
namespace API.Services
{
    ...
    { 
            ...
            Task<FilteredPaginatedList<ProductDTORequest>> GetProductList(int? spaId = null, int pageIndex = 1, int pageSize = 10, string? searchTerm = null, string? categoryName = null, string? quantityRange = null, string? priceRange=null);
